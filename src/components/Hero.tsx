        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              ...
              className="text-center p-6 bg-card/50 backdrop-blur-sm rounded-2xl border border-border hover:border-brand-primary/50 transition-all duration-300"
            >
              <motion.div
            ...
            <motion.div
              whileHover={{ y: -10, scale: 1.05 }}
              className="text-center p-6 bg-card/50 backdrop-blur-sm rounded-2xl border border-border hover:border-brand-secondary/50 transition-all duration-300"
            >
              <motion.div
            ...
            <motion.div
              whileHover={{ y: -10, scale: 1.05 }}
              className="text-center p-6 bg-card/50 backdrop-blur-sm rounded-2xl border border-border hover:border-brand-accent/50 transition-all duration-300"
            >
              <motion.div
                animate={{ rotate: [0, -360] }}
